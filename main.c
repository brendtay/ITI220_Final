...
//Sets output for p6 bit 1-4
#define SETP6(a, b, c, d) (P6DIR |= ((a) | (b) | (c) | (d)))
//Sets output for p4 bit 5-7
#define SETP4(a, b, c) (P4DIR |= ((a) | (b) | (c)))
//Sets output for p3 bit 8-9
#define SETP3(a, b) (P3DIR |= ((a) | (b)))
...
#define ONP3(x) (P3OUT |= (x))
#define OFFP3(x) (P3OUT &= ~(x))
...
void setup(){
    ...
    SETP6(P2S1, P2S2, P2S3, P2S4);
    SETP4(P2S5, P2S6, P2S7);
    SETP3(P2S8, P2S9);
